...
""" PART b) START """
#%%
words = ['pride','prejudice','elizabeth','darcy','charlotte','love','hate',
         'marriage','husband','wife','father','mother','daughter','family',
         'dance','happy']
books_lemmatizedtexts[0].dispersion_plot(words)
